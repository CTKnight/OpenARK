...
namespace ark {
    ...
    void MockD435iCamera::start(){
        ...
        imuReaderThread_ = std::thread(&MockD435iCamera::imuReader, this);
    }

    void MockD435iCamera::imuReader(){
        while(!kill){
    ...
    std::vector<ImuPair> MockD435iCamera::getAllImu() {
    ...
    void MockD435iCamera::project(const rs2::frame & depth_frame, cv::Mat & xyz_map) {
